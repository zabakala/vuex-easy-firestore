...
import { isString, isPlainObject, isArray, isFunction, isAnyObject, isDate, isNumber } from 'is-what';
import { __spreadArray, __awaiter, __generator, __assign } from 'tslib';
...
function worker$1 (context = self) {
...
var ArrayUnion = /** @class */ (function () {
    ...
    ArrayUnion.prototype.getFirestoreFieldValue = function () {
        return arrayUnion$1.apply(void 0, this.payload);
    };
    return ArrayUnion;
}());
var ArrayRemove = /** @class */ (function () {
    ...
    ArrayRemove.prototype.getFirestoreFieldValue = function () {
        return arrayRemove$1.apply(void 0, this.payload);
    };
    return ArrayRemove;
}());
function arrayUnion() {
    ...
    return new (ArrayUnion.bind.apply(ArrayUnion, __spreadArray([void 0], payload)))();
}
function arrayRemove() {
    var payload = [];
    for (var _i = 0; _i < arguments.length; _i++) {
    ...
    return new (ArrayRemove.bind.apply(ArrayRemove, __spreadArray([void 0], payload)))();
}
...
var Increment = /** @class */ (function () {
    ...
    Increment.prototype.getFirestoreFieldValue = function () {
        return increment$1(this.payload);
    };
    return Increment;
}());
function increment(payload) {
...
function pluginActions (firestoreConfig) {
    ...
    return {
        ...
        duplicate: function (_a, id) {
            _a.state; var getters = _a.getters; _a.commit; var dispatch = _a.dispatch;
        ...
        patchDoc: function (_a, _b) {
            var state = _a.state, getters = _a.getters; _a.commit; var dispatch = _a.dispatch;
            var _c = _b === void 0 ? {
                ids: [],
                doc: {},
        ...
        deleteDoc: function (_a, payload) {
            var state = _a.state; _a.getters; _a.commit; var dispatch = _a.dispatch;
        ...
        insertInitialDoc: function (_a) {
            var state = _a.state, getters = _a.getters; _a.commit; _a.dispatch;
            // 0. only docMode
            if (getters.collectionMode)
                return;
        ...
        handleSyncStackDebounce: function (_a, payloadToResolve) {
            var state = _a.state; _a.commit; var dispatch = _a.dispatch, getters = _a.getters;
            return new Promise(function (resolve, reject) {
        ...
        batchSync: function (_a) {
            var getters = _a.getters; _a.commit; var dispatch = _a.dispatch, state = _a.state;
            var batch = makeBatchFromSyncstack(state, getters, writeBatch(getFirestore(firebase)));
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            ref = getters.dbRef;
                            return [4 /*yield*/, getDoc(doc(ref, id))];
                        case 1:
                            _doc = _b.sent();
                            if (!_doc.exists) {
                                if (state._conf.logging) {
                            ...
                            doc$1 = getters.cleanUpRetrievedDoc(_doc.data(), id);
                            dispatch('applyHooksAndUpdateState', { change: 'added', id: id, doc: doc$1 });
                            return [2 /*return*/, doc$1];
                        case 2:
                            e_1 = _b.sent();
                            error(e_1);
                            throw e_1;
        ...
        _a, _b) {
            _a.getters; var state = _a.state, commit = _a.commit, dispatch = _a.dispatch;
        ...
        closeDBChannel: function (_a, _b) {
            _a.getters; var state = _a.state, commit = _a.commit; _a.dispatch;
        ...
        set: function (_a, doc) {
            _a.commit; var dispatch = _a.dispatch, getters = _a.getters, state = _a.state;
            if (!doc)
                return;
            if (!getters.collectionMode) {
        ...
        insert: function (_a, doc$1) {
            ...
            var newDoc = doc$1;
            if (!newDoc.id)
                newDoc.id = doc(getters.dbRef).id;
        ...
        patchBatch: function (_a, _b) {
            var state = _a.state; _a.getters; var commit = _a.commit, dispatch = _a.dispatch;
...
export { arrayRemove, arrayUnion, vuexEasyFirestore as default, filterPatchDeleteItems, increment, isPatchingByDeleting, vuexEasyFirestore };
