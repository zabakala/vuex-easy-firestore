...
function arrayUnion() {
    ...
    return new (ArrayUnion.bind.apply(ArrayUnion, tslib.__spreadArray([void 0], payload)))();
}
function arrayRemove() {
    var payload = [];
    for (var _i = 0; _i < arguments.length; _i++) {
    ...
    return new (ArrayRemove.bind.apply(ArrayRemove, tslib.__spreadArray([void 0], payload)))();
}
    ...
    return {
        ...
        duplicateBatch: function (_a, ids) {
            ...
            if (!isWhat.isArray(ids) || !ids.length)
                return {};
            return ids.reduce(function (carry, id) { return tslib.__awaiter(_this, void 0, void 0, function () {
                var idMap;
        ...
        fetchAndAdd: function (_a, parameters) {
            ...
            if (!getters.collectionMode) {
                ...
                return firestore.getDoc(getters.dbRef)
                    .then(function (_doc) { return tslib.__awaiter(_this, void 0, void 0, function () {
                    var message, id, doc;
                    return tslib.__generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
        ...
        openDBChannel: function (_a, parameters) {
             ...
             */
            function (snapshot) { return tslib.__awaiter(_this, void 0, void 0, function () {
        ...
        patchBatch: function (_a, _b) {
            ...
            function storeUpdateFn(_doc, _ids) {
                _ids.forEach(function (_id) {
                    commit('PATCH_DOC', tslib.__assign({ id: _id }, _doc));
                });
...
function iniModule (userConfig, firestoreConfig) {
    ...
    return {
        ...
        mutations: tslib.__assign(tslib.__assign({}, userMutations), pMutations),
        actions: tslib.__assign(tslib.__assign({}, userActions), pActions),
        getters: tslib.__assign(tslib.__assign({}, userGetters), pGetters),
    };
}
